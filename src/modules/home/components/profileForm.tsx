          ...
          <div className="p-8">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="form-group">
                    <label htmlFor="linkedin" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                  ...
                  <div className="form-group">
                    <label htmlFor="github" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                  ...
                  <div className="form-group">
                    <label htmlFor="twitter" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                  ...
                  <div className="form-group">
                    <label htmlFor="sitio_web" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
